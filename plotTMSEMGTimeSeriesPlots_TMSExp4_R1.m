...
FigurePath = ['Z:\StudentFolders\Cody\Projects\TMS\Figures\Figs4Paper_R3\TMSExp4\'];

load('SavedEMGData\allSubjData_norm_TMSExp4_R1Data.mat')
...
MEPtime(1,:) = [PertOnTime-0.060*Fs  PertOnTime-0.030*Fs];
MEPtime(2,:) = [PertOnTime-0.060*Fs  PertOnTime-0.030*Fs];
MEPtime(3,:) = [PertOnTime-0.060*Fs  PertOnTime-0.030*Fs];
MEPtime(4,:) = [PertOnTime-0.060*Fs  PertOnTime-0.030*Fs];
MEPtime(5,:) = [PertOnTime-0.060*Fs  PertOnTime-0.030*Fs];
MEPtime(6,:) = [PertOnTime-0.060*Fs  PertOnTime-0.030*Fs];
...
postMEPPeriod = [900:1100]; % -20 to +20 ms
